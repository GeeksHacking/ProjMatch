        ...
        <div className='absolute flex w-full h-full flex-col justify-start items-center'>
            ...
            <div className='absolute flex w-[70%] h-full flex-col justify-start items-start my-10'>
                <form className="flex flex-col justify-start items-start w-full">
                    ...
                    <input type="text" name="projectName" placeholder="Enter your project’s name! e.g. AmazingClicker" value="PreviousValueHere" className="w-[70%] h-11 rounded-lg border-2 border-[#D3D3D3] px-2"/>
                    ...
                    <textarea name="projectDescription" placeholder="Enter your project’s description!" value="PreviousValueHere" className="w-[70%] h-32 rounded-lg border-2 border-[#D3D3D3] px-2 py-1"/>
                    ...
                    <input type="text" name="projectContact" placeholder="Enter your project’s contact! e.g. https://discord.gg/AmazingClicker" value="PreviousValueHere" className="w-[70%] h-11 rounded-lg border-2 border-[#D3D3D3] px-2"/>

                    <h2 className="text-3xl font-medium mt-10">Tags</h2>
                    <p className="text-lg mt-1">Add tags to help users find your project!</p>
                    <input type="text" name="projectTags" placeholder="Enter your project’s tags! e.g. Clicker, Game, Fun" value="PreviousValueHere" className="w-[70%] h-11 rounded-lg border-2 border-[#D3D3D3] px-2"/>
